    ...
    useEffect(() => {
      ...
      const handleSubmit =  (event: { preventDefault: () => void; }) => {
        axios({
            ...
            const userWithSelectedFields = user.map(user => ({
                id: user.id,
            ...
            setUser(userWithSelectedFields);
            sessionStorage.setItem('user', JSON.stringify(userWithSelectedFields));
            // sessionStorage.setItem('accessToken',accessToken);
            
            console.log(accessToken);
            router.push('http://localhost:8080/listcourses');  
