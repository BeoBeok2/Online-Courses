    ...
    <div className={Styles.container}>
      ...
      <div className={Styles.form_container}>
        <form onSubmit={displayLessonsData}>
          ...
          <input type="text" id={Styles.courseName} name="courseName" required /> */}
          ...
          <div id="lessons">
            {lessonsData.map((lesson, lessonIndex) => (
              <div key={lessonIndex} className={Styles.lesson_input}>
                ...
                <input type="file" id={`lessonVideo${lessonIndex}`} name="lessonVideo[]" required />
          ...
          <input type="submit" className={Styles.submit_button} value="Tạo khóa học"  id={Styles.button}/>
        </form>
      </div>
    </div>
  );
